...
public class MyTrainWebSocketHandler implements WebSocketHandler {
...
//        }
        ...
        if (sessions.containsKey(username)) {
            System.out.println("username:" + username + "已经连接");
    ...
    public void afterConnectionClosed(WebSocketSession session, CloseStatus status) throws Exception {
        ...
        System.out.println(getUsernameFromUri(session.getUri().toString())+"连接关闭");
